...
('tokyo-1', '203.0.113.10|VLESS+WS|443', '203.0.113.10', 'Japan', 'Tokyo', 'VLESS+WS', 443, 1, 192304.0, 18203402, unixepoch() - 120),
('tokyo-1', '203.0.113.10|VLESS+WS|443', '203.0.113.10', 'Japan', 'Tokyo', 'VLESS+WS', 443, 1, 214201.0, 18588482, unixepoch() - 30),
('sj-1', '203.0.113.11|Reality|8443', '203.0.113.11', 'United States', 'Los Angeles', 'Reality', 8443, 0, 86312.0, 6244912, unixepoch() - 90),
('hk-1', '203.0.113.12|Trojan|10001', '203.0.113.12', 'Hong Kong', 'Hong Kong', 'Trojan', 10001, 0, 45212.0, 3188411, unixepoch() - 240);
