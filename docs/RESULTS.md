...
- `node-b`: monitored VPS used for safe CPU-only fault injection.
...
|---|---:|---:|---:|---:|---:|---:|---|
| `node-b-20260421T045458Z-cpu` | 150s | yes | 27s | yes | 27s | 100% | `Node degraded` |
| `node-b-20260421T062448Z-cpu` | 60s | yes | 37s | yes | 37s | 100% | `Node degraded` |
| `node-b-20260421T153933Z-cpu` | 90s | yes | 37s | yes | 7s | 100% | `Node degraded` |

An expanded matrix (3 reps × {30s, 60s, 150s, 300s} on `node-b`)
